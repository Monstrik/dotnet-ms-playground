...
wait_for_url "order-producer-service" "http://localhost:8091/health"
wait_for_url "kitchen-service" "http://localhost:8092/health"
wait_for_url "delivery-service" "http://localhost:8093/health"
...
echo "  curl http://localhost:8091/queues"
echo "  curl http://localhost:8092/stats"
echo "  curl http://localhost:8093/stats"
